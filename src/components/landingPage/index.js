      ...
      <div className="flex flex-col flex-1 h-full items-center justify-center">
        <div className="flex flex-col flex-1 justify-evenly">
          <div className="font-saira text-white text-center px-10 max-w-sm sm:max-w-xl">
            ...
            <div className="w-64 text-xs sm:w-96 sm:text-sm mx-auto font-extralight text-gray-400 animate-fadeIn opacity-0" style={{ animationDelay: "200ms", WebkitAnimationDelay: "200ms" }}>
          ...
          <div>
            <div className="flex flex-col items-center w-52 mx-auto text-center font-sairaCondensed font-semibold text-lg">
              ...
              <a className="w-full opacity-0 animate-fadeInLeft" style={{ animationDelay: "200ms", WebkitAnimationDelay: "200ms" }} href={data.cexButtonLink}>
