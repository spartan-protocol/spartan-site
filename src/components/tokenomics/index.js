...
const Token = () => {
  ...
  return (
    <div id="tokenomics" className="h-screen max-h-screen overflow-y-autofont-saira font-medium sm:hidden bg-black sm:w-10/12 sm:mx-auto justify-center flex flex-col snap-start">
