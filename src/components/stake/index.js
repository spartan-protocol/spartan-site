...
const Stake = ({ data }) => {
  return (
    <div id="stake" className="h-screen bg-black justify-center">
      <div className="flex flex-col flex-1 h-full items-center justify-center">
        <div className="flex flex-col flex-1 justify-evenly relative z-10">
          <div className="font-saira text-white text-center px-8">
            ...
            <div className="w-64 text-xs sm:w-96 sm:text-sm mx-auto font-extralight text-gray-400 bg-black rounded">{data.subtitle}</div>
          </div>
          <div>
