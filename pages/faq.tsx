            ...
            <div className="col-lg-8 col-md-12">
              <div class="schema-faq-code" itemscope="" itemtype="https://schema.org/FAQPage">
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">What is Spartan Protocol?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">The Spartan Protocol is a wholesome and complete protocol that allows the safe growth of synthetic assets, lending markets and for all assets to be liquid and productive.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Who are the founders?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">The project is galvanized by communities of former Binance Chain projects. The project begins decentralised from day 0; there is no official team and no treasury.
              </p>
                    </div>
                </div>

                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Is the team anonymous?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">Yes, the Spartan Protocol is a community driven initiative with a wide and varied source of contributors. It draws inspiration from Thorchain and other projects that elected to go anonymous in line with the world’s most known token, Bitcoin.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">No airdrop — No founder/team tokens — No presale</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">Zero, none, nada — Like the 300 Spartans that held Hells Gate, the team believe in the true intent of DeFi to provide open solutions for all on an equal playing field.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">I see this is a community project, so how can I contribute or influence the direction of Spartan Protocol?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">When the protocol is launched, all token holders have the power to vote on changes within the network by partaking in the DAO governance. Every token holder has a voice.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">How do I obtain SPARTA tokens?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">Spartan Protocol starts decentralised from day one. To acquire SPARTA you will need to send your tokens through a smart contract on the Spartan Protocol DApp. The tokens you send through this contract will be ‘burnt’.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">So do I need to buy coins to get tokens?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">Not necessarily; to obtain SPARTA tokens you will need to have tokens from one of the chosen 30 BEP projects to burn in exchange to SPARTA.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Why is burning the collateral necessary, can’t we donate it somewhere or use the funds as a treasury?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">By burning your tokens to receive SPARTA, it shows an individual’s commitment to the project, every token has an inherent value associated with it set by the market.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">What happens if the whole 100m SPARTA allocation is not burned? Is there any expiry date to burn my tokens?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">If the 100m of proof-of-burn obtained tokens are not fully acquired, it stays open indefinitely until it does. Or until the incentives erode the other 200m and squeeze the tokens out.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">I am interested but not keen to risk a lot of money! Is there a minimum amount i can burn?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">There is no minimum qty! Binance Smart Chain fees are also very low which allows for smaller token holders to participate.</p>
                    </div>
                </div>

                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">What about a maximum?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">The community pointed out that there was a way around our initial idea of max allocation per wallet; it’s quite obvious really; just make multiple wallets.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Do I need BNB to use Spartan Protocol?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">Yes, you will require a small amount of BNB in your wallet to pay for transactions, other operations and staking. BNB performs the same function as ETH for Ethereum (aka ‘gas’)
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Can other tokens be burnt for SPARTA tokens?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">Only 30 exclusive projects have been selected for the burning event, but once the DApp is live you will be able to swap a vast array of tokens for SPARTA and vice versa.</p>
                    </div>
                </div>

                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">How is the rate of burn determined?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">The $0.30 SPARTA initial value comes from how we developed the economic model. We chose 300 million max tokens based on…. well… Sparta! Following that decision, 100 million of those will from the initial proof-of-burn distribution instead of what would normally be a blood-sucking ICO or dusty airdrop!
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">How is the snapshot price determined?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">The snapshot price for each token enabled for the burn will be locked on the burn date. It will be based on a 14 day rolling average price of each token.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Why does SPARTA need to be the settlement asset in every pool?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">The Spartan Protocol is a liquidity protocol for asset exchange and synthetic asset generation on Binance Smart Chain. The first foundation of Spartan is its liquidity pools, similar to Uniswap, but instead of a fixed-rate fee model it uses a liquidity-sensitive fee similar to THORChain’s slip-based fees.
                ...
                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Will there be lockup for staking tokens?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">There is no lock-up for staking, rewards will be calculated each block and claimable daily.
              </p>
                    </div>
                </div>

                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Is the protocol audited?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">The audit has been funded by the community and is currently in motion. We will announce the results when more information arises.
              </p>
                    </div>
                </div>

                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">Does Spartan protocol require price feeds, oracles etc?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">No, Spartan Protocol uses a continuous liquidity pools design with arbitrage opportunities balancing the prices. Essentially if the value of the token in a pool is out of sync with the market, arbitrage bots and traders will bring funds in and swap it back in balance.
              </p>
                    </div>
                </div>

                <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="faq-question">
                    <h3 itemprop="name" class="faq-q">What wallets are compatible with Spartan Protocol?</h3>
                    <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                         <p itemprop="text" class="faq-a">Most existing Ethereum tooling is compatible with BSC, however currently we have only integrated MetaMask with the Spartan protocol DApp thus far.
